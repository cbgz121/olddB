...
func sAdd(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) <= 1 {
...
func sPop(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func sIsMember(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func sRandMember(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func sRem(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) <= 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sMove(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func sCard(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func sMembers(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func sUnion(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) <= 0 {
...
func sDiff(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) <= 0 {
...
func sKeyExists(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) <= 0 {
...
func sClear(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func sExpire(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func sTTL(db *oldrosedb.RoseDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
